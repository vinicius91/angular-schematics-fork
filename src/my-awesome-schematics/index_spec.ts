...
describe('my-awesome-schematics', () => {
    ...
    describe('with project', () => {
        ...
        it('fails with missing tree', () => {
            expect(() => testRunner.runSchematic('my-awesome-schematics', {}, Tree.empty())).toThrow();
        });

        it('fails with missing params', () => {
            expect(() => testRunner.runSchematic('my-awesome-schematics', {}, appTree)).toThrow();
        });

        it('works', () => {
            const tree = testRunner.runSchematic('my-awesome-schematics', {
                name: "test"
            }, appTree);
